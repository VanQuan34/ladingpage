...
for (let i = 0; i < rowCount; i++) {
  ...
  cell.innerHTML = '<div class="mo-comp" resizable="false" draggable="false" removable="false" moveable="" mo-type="text" data-mo-type="default" data-highlightable="1"><p class="font-8 mo-text" data-highlightable="1" data-mo-type="text">Column1</p></div>';
}
    this.setValue();
    this.detectChanges();
...
const numberOfColumns = firstRow.cells.length;
...
// this.selectedComp.find('tbody')[0].append(`<tr>Xin chao</td>`, {});
    this.detectChanges();
    getPosition();
    this.updateDockingPosInfo();
  }
...
function getPosition(){
  const table = GLOBAL.editor.getSelected().view.el
