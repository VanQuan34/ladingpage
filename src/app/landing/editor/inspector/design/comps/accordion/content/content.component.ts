...
@Component({
  selector: 'mo-wb-landing-editor-inspector-design-comps-accordion-content',
  templateUrl: './content.component.html',
  styleUrls: ['./content.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MoLandingEditorInspectorLayoutCompsAccordionContentComponent extends MoLandingEditorInspectorBaseComponent {
